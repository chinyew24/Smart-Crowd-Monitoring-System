...
class TfPoseEstimator:
    ...
    def trans_data(humans):
        ...
        for human in humans:
            ...
            #print("new method:", n_human)
            #print("done new method")
       ...
       # centers = {}
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                #print("round", record_joints_norm)
                xs.append(center[0])
                ys.append(center[1])
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 4)
            tl_x = min(xs)
            tl_y = min(ys)
            width = max(xs) - min(xs)
